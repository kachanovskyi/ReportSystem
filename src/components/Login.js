        ...
        <div className="Login">
            <div className="row table-cell">
                <Col xs={8} xsOffset={2} md={6} mdOffset={3} lg={4} lgOffset={4} className="login-form">
                    ...
                    <form onSubmit={login}>
                        <input type="email" name="login" id="inputLogin" placeholder="Електронна скринька"
                               required/>
                        <div className="password-container">
                            <input type="password" name="password" id="inputPass" placeholder="Пароль" required/>
                            <img src="/public/images/eye-icon.svg" alt="кнопка відображення паролю" onMouseDown={displayPass} onMouseUp={hidePass}
                                 onMouseOut={hidePass}/>
                        </div>
                ...
                <p className="text-center copyright">© 2017 BotsCrew. Усі права захищені</p>
            </div>
            <NotifyModal/>
        </div>
    );
